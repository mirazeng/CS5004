...
def test_check_valid_row(row, expect):
    ...
    Returns: None — This function does not return a value; it prints the test results to the console.
...
def test_squares():
    ...
    Parameters: None
    Returns: None — It only calls respective functions and let them print to terminal
