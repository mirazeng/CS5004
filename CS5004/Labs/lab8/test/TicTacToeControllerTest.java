 ...
 *  using mocks for readable and appendable. */
public class TicTacToeControllerTest {
  ...
  public void testSingleValidMove() {
    ...
    TicTacToeConsoleController c =
        new TicTacToeConsoleController(new StringReader("2 2 q"), gameLog);
    c.playGame(m);
    assertEquals(
        "   |   |  \n"
            + "-----------\n"
  ...
  public void testBogusInputAsRow() {
    ...
    StringBuilder gameLog = new StringBuilder();
    TicTacToeConsoleController c = new TicTacToeConsoleController(input, gameLog);
    c.playGame(m);
