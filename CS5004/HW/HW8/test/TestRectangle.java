...
public class TestRectangle {
  ...
  public void setup() {
    ...
    testRectangle = new Rectangle("rect1", "rectangle", testPosition, 80, 40, testColor);
  }
  ...
  public void testRectangleConstructor() {
    ...
    assertEquals(testColor, testRectangle.getColor());
  }
  ...
  public void testResize() {
    testRectangle.resize(1.5, 2);
    assertEquals(120, testRectangle.getWidth());
    assertEquals(80, testRectangle.getHeight());
  }
  ...
  public void testToString() {
    String expectedString =
        "Name: rect1\n"
            + "Type: rectangle\n"
            + "Min corner: (50.0,100.0), Width: 80.0, Height: 40.0, Color: (0.0,255.0,0.0)\n";
