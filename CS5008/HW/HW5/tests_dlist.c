...
// Test if the add_front function adds a new node to the front of an empty list
...
// Test if the add_front function adds a new node to the front of a list with multiple elements
...
// Test if the add_back function adds a new node to the back of an empty list
...
// Test if the add_back function adds a new node to the back of a list with multiple elements
...
// Test if the remove_front function removes the first node from an empty list
...
// Test if the remove_front function removes the first node from a list with one node
...
// Test if the remove_front function removes the first node from a list with multiple nodes
...
// Test if the remove_back function removes the last node from an empty list
...
// Test if the remove_back function removes the last node from a list with one node
...
// Test if the remove_back function removes the last node from a list with multiple nodes
...
// Test if the get function returns -1 when the index is negative
...
// Test if the get function returns -1 when the index is out of bound
...
// Test if the get function returns the correct element when the index is in bound
int test_get_with_index_in_bound()
{
    ...
    if (result != 3) {
        printf("The result does not match and should expected 3 "
               "but got %d\n", result);
        destroy(list);
        return 0;
    }
...
// Test if the set function does not change the list when the index is negative
...
// Test if the set function does not change the list when the index is out of bound
...
// Test if the set function changes the list when the index is in bound
